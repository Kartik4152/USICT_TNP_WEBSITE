  ...
  return (
    <div id="footer" className='bg-[#242424] w-full flex flex-col items-center'>
        <div className='w-3/5 py-12 text-white'>
            <div className='flex items-center w-full justify-between border-b-4 pb-8 px-8 mb-8 border-[#777777]'>
            ...
            <div className='flex justify-between w-full'>
              ...
              <img src={QrCode} alt="qr code" className='w-64 h-64 object-contain object-right'/>
            </div>
        </div>
